#ifndef NAOLAND_SEAT_HPP
#define NAOLAND_SEAT_HPP
...
public:
    struct Listeners {
        ...
        explicit Listeners(Seat& parent) noexcept
            : parent(parent)
        {
        }
    };
...
public:
    ...
    void apply_constraint(wlr_pointer const* pointer, double* dx,
                          double* dy) const;
    bool is_pointer_locked(wlr_pointer const* pointer) const;
};
